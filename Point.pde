...
class Point {
  ...
  ArrayList<PixelScore> mesPixels;
  ...
  Point(PixelScore monPoint) {
    ...
    pointMoyen = new PVector(monPoint.x, monPoint.y);
  }
   ...
   */
  PVector calculPointMoyen(ArrayList<PixelScore> listePoints) {
   ...
   * @return un point de type PVector, qui correspond au point moyen du nuage de pixel;
   */
  PVector nonMinSuppressor(ArrayList<PixelScore> listePixels) {
